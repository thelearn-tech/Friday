...
# by thelearn-tech
# Only to used with friday assistance
...
def help_text():
    print(green + "A simple Rock, Paper, Scissor Game")
    print("of 5 rounds")
    print(yellow + "Rules")
    print(" ")
    ...
    time.sleep(0.4)
    print(" ")
    nothing = input(default + "Enter to continue")
    os.system('clear')
...
for game in range(5):
    ...
    if  pl == "rock" or pl == "1":
        ...
        if computer == "scissor":
            ...
            print(" ")
            print(" ")
            print(orange + " You Won " + green + "round " + std(rund))
            print(" ")
            my_score += 1
            rund += 1
            time.sleep(3)
